...
print(f"DEBUG: Converting {args.pdbqt_ligs} to {args.output_pdb} using obabel...")
try:
    subprocess.run(f'obabel -ipdbqt {args.pdbqt_ligs} -opdb -O {args.output_pdb}', shell=True, check=True, capture_output=True, text=True)
